              ...
              Padding(
                ...
                child: FutureBuilder<ApiCallResponse>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    return Builder(
                      builder: (context) {
                        final dcRotas = BuscarRotasCall.resultado(
                              listViewBuscarRotasResponse.jsonBody,
                            )?.toList() ??
                            [];
                        return ListView.builder(
                          ...
                          itemCount: dcRotas.length,
                          itemBuilder: (context, dcRotasIndex) {
                            final dcRotasItem = dcRotas[dcRotasIndex];
                            return Container(
                              height: 80.0,
                              decoration: BoxDecoration(
                                color: FlutterFlowTheme.of(context)
