...
import 'pagetest_model.dart';
export 'pagetest_model.dart';
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      if ((_model.shipmentsresult?.succeeded ?? true)) {
        setState(() {
          FFAppState().appstateteste = getJsonField(
              ...
              Padding(
                ...
                child: FutureBuilder<ApiCallResponse>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    final listViewBuscarRotasResponse = snapshot.data!;
                    return Builder(
                      builder: (context) {
                        final listview1 = FFAppState().appstateteste.toList();
                        return ListView.builder(
                          ...
                          itemBuilder: (context, listview1Index) {
                            final listview1Item = listview1[listview1Index];
                            return Container(
                              height: 80.0,
                              decoration: BoxDecoration(
                                color: FlutterFlowTheme.of(context)
